          ...
          <td>
            ...
            <table>
              ...
              <tbody>
                ...
                <tr>
                  <td><div class="results__cell--scrollable">${result.date}</div></td>
                  <td><div class="results__cell--scrollable">${result.time}</div></td>
                  <td><div class="results__cell--scrollable">${result.x}</div></td>
                  <td><div class="results__cell--scrollable">${result.y}</div></td>
                  <td><div class="results__cell--scrollable">${result.r}</div></td>
                  <td><div class="results__cell--scrollable">${result.hit}</div></td>
                </tr>
                </c:forEach>
              </tbody>
            </table>
